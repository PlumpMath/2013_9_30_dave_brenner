...
<div class="box bg-1">
	<div class="box measure bg-0 border-left border-bottom-0">
		...
		<div class="box box-pad-0 bg-0 border-bottom-0">The atmosphere is lively and fun, and this non-competitive environment makes for maximizing good experiences, making new friends, and most of all, creating a desire to continue with the sport.</div>
		...
		<div class="box box-pad-0 bg-0 border-bottom-0">Our Special Needs programs are geared for individuals with developmental challenges. All programs are run by certified professionals in their respective fields. Special educators frequently supervise and interact with classes and students.</div>
		@include('modules.section_divide', ['name' => 'Tennis'])
		<div class="box box-pad-0 bg-0 border-bottom-0">Our tennis program is set up in a safe, easy-to-succeed environment through the use of modified equipment to maximize success. Players have an opportunity to learn racquet control, eye-hand coordination, increase listening and interactive skills and increase socialization skills through on-court assistants that assist players as needed. Attainable goals are set up for all activities presented. Ages 8 – 18.</div>
		@include('modules.section_divide', ['name' => 'Art'])
		<div class="box box-pad-0 bg-0 border-bottom-0">Art is a natural for special needs. Through exposure to a variety of crafts projects, students draw, paint, sculpt, glue, and creatively enhance projects. Although we do have assistants, parents are encouraged to join in. Ages 5 – 18.</div>
	</div>
