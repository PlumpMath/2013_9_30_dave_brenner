...
<div class="index box bg-1">
    ...
    <div class="box-4 bg-0 border-left">
        ...
        {{ Form::open(['url' => $url['edit'], 'method' => 'POST']) }}
        <ul class="box pl box-pad-0 rsrc">
            <li class="box-pad-0">
                Will you be adding any dates or grade restrictions to this lesson? Add together the number of black out dates, make-ups, lessons, etc.
            </li>
